...
function ItemCustomerFeeManagement(props) {
	const { item } = props;
...
ItemCustomerFeeManagement.propTypes = {
	item: PropTypes.object,
};

ItemCustomerFeeManagement.defaultProps = {
	item: {},
};

export default ItemCustomerFeeManagement;
