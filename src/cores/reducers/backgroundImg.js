...
export const reducersBackgroundImg = createSlice({
	...
	initialState: {
		data: [
			...
			{ id: 1, img: a10, status: false },
			{ id: 2, img: a9, status: false },
			{ id: 3, img: a11, status: false },
			{ id: 4, img: a12, status: false },
			{ id: 5, img: a13, status: false },
			{ id: 6, img: a14, status: false },
			{ id: 7, img: a15, status: false },
			{ id: 8, img: a16, status: false },
			{ id: 9, img: a17, status: false },
			{ id: 10, img: a18, status: false },
			{ id: 11, img: a19, status: false },
			{ id: 12, img: a20, status: false },
			{ id: 13, img: a21, status: false },
			{ id: 14, img: a22, status: false },
			{ id: 15, img: a23, status: false },
			{ id: 16, img: a24, status: false },
			{ id: 17, img: a26, status: false },
			{ id: 18, img: a28, status: false },
			{ id: 19, img: a31, status: false },
			{ id: 20, img: t1, status: false },
			{ id: 21, img: t3, status: false },
			{ id: 22, img: t4, status: false },
			{ id: 23, img: t5, status: false },
			{ id: 24, img: t6, status: false },
			{ id: 25, img: t7, status: false },
			{ id: 26, img: t8, status: false },
			{ id: 27, img: t9, status: false },
			{ id: 28, img: t10, status: false },
			{ id: 29, img: t11, status: false },
			{ id: 30, img: t12, status: false },
		],
	},
	reducers: {
